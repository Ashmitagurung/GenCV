...
class ProjectRAG:
    ...
    """
    def __init__(self, index_id: str = 'project_rag'):
        ...
        self.llm = None
        self.qa_chain = None
        self.json_file = self.config.projects_dir+"/naxa_projects_old_summaries.json"
    ...
    async def query(self, project_name: str, position: str) -> dict | None:
        """Performs a query against the RAG system using project_name and position."""
        question = f"What activities did the {position} perform for the '{project_name}' project?"
        ...
        try:
            ...
            try:
                ...
                structured_response = {
                    "Name of the assignment or project": project_name,
                    "Year": "N/A",
                    "Location": "N/A",
                    "Client": "N/A",
